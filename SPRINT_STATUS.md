...
| `0405cc0` | **UI**: Параметры page второй редизайн — карточные секции, hero IRR 28px, CoeffRow с растяжными барами, empty state правой панели | D-PARAMS-1 |
...
|-----|----------|---------|------|---------------|
| DEF-031 | Significant | `rpc_list_feed_prices` не зарегистрирована в `rpc_name_registry` | `d03_feed.sql:1839` | **DB Agent**: добавить INSERT в registry block в `d01_kernel.sql` |
