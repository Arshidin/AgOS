              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-border/40 bg-muted/40">
                    <th className="px-4 py-2 text-left text-[11px] font-medium text-muted-foreground uppercase tracking-wide min-w-[180px]">Группа животных</th>
                    {Array.from({ length: years }, (_, i) => (
                      <th key={i} className="px-2 py-2 text-right text-[11px] font-medium text-muted-foreground uppercase tracking-wide whitespace-nowrap">Год {i + 1}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
