          ...
          <div className="flex items-center justify-end" style={{ position: "relative", zIndex: 2 }}>
            ...
            <Link
              ...
              style={{
                ...
                width: (isMobile || scrolled) ? (isMobile ? 44 : 32) : "auto",
                height: isMobile ? 44 : 32,
            ...
            >
              ...
              <ArrowRight
                ...
                style={{
                  flexShrink: 0,
                  width: scrolled ? 16 : (isMobile ? 18 : 14),
                  opacity: 1,
                  transition: `width ${T}`,
                }}
              />
            ...
            {navLinks.map((link) =>
              link.external ? (
                <a
                  key={link.key}
                  href={link.to}
                  className="px-6 py-3.5 text-sm font-medium hover:bg-black/5 transition-colors"
                  style={{ color: "#3D2B1F" }}
                  onClick={() => setMenuOpen(false)}
                >
                  {t(`navbar.${link.key}`)}
