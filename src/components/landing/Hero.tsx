...
const Hero = () => {
  ...
  /* TODO: Fetch live counter from AgOS supabase when client is available
  useEffect(() => {
    supabase
      .from('app_counters')
      .select('value')
  ...
  */
  ...
  return (
    <section className="pt-28 md:pt-36 pb-0 relative">
      {/* Decorative tumar ornament */}
      <TumarOrnament className="absolute top-32 md:top-40 left-4 md:left-[10%] opacity-[0.15] w-[80px] md:w-[110px] pointer-events-none" />
      ...
      <Reveal delay={400}>
        <div id="hero-cards" className="mt-16 md:mt-20 flex gap-4 overflow-x-auto overflow-y-hidden scrollbar-hide">
